...
const ge = "ontouchstart"in window || window.DocumentTouch && document instanceof DocumentTouch
  ...
  , nn = navigator.userAgent.toLowerCase().indexOf("android") !== -1
  , rn = /Chrome/.test(navigator.userAgent) && /Google Inc/.test(navigator.vendor)
  , on = (()=>{
    try {
  ...
  , Te = (/iPad|iPhone|iPod/.test(navigator.platform) || navigator.platform === "MacIntel" && navigator.maxTouchPoints > 1) && !Ds.MSStream
  , J = "safari"in Ds || !!(xe && (/\b(iPad|iPhone|iPod)\b/.test(xe) || xe.match("Safari") && !xe.match("Chrome")))
  , Me = navigator.userAgent.toLowerCase().indexOf("firefox") > -1
  , ze = J && Te
  , ie = (navigator.maxTouchPoints === void 0 || navigator.maxTouchPoints > 0) && navigator.userAgent.search(/iOS|iPhone OS|Android|BlackBerry|BB10|Series ?[64]0|J2ME|MIDP|opera mini|opera mobi|mobi.+Gecko|Windows Phone/i) != -1
